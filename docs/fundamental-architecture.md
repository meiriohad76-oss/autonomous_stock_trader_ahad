...
- replayable sample company fundamentals in [data/sample-fundamentals.json](/C:/Users/meiri/OneDrive/Documents/trading%20system/data/sample-fundamentals.json)
- a scoring engine in [src/domain/fundamentals.js](/C:/Users/meiri/OneDrive/Documents/trading%20system/src/domain/fundamentals.js)
- live HTTP endpoints in [src/http/router.js](/C:/Users/meiri/OneDrive/Documents/trading%20system/src/http/router.js)
- a dedicated dashboard in [src/public/fundamentals.html](/C:/Users/meiri/OneDrive/Documents/trading%20system/src/public/fundamentals.html)
- a materialized warehouse view in [src/domain/fundamental-persistence.js](/C:/Users/meiri/OneDrive/Documents/trading%20system/src/domain/fundamental-persistence.js)
...
The current runtime also persists a warehouse-style slice of the fundamentals state into dedicated relational tables so coverage rows, market-reference rows, factor rows, score rows, and any SEC-derived filing/fact rows can be inspected through the API and recovered after restart.
...
The runtime in [src/domain/fundamentals.js](/C:/Users/meiri/OneDrive/Documents/trading%20system/src/domain/fundamentals.js) should remain the reference for:
...
- [schemas/fundamental-score.schema.json](/C:/Users/meiri/OneDrive/Documents/trading%20system/schemas/fundamental-score.schema.json)
- [schemas/fundamental-sector.schema.json](/C:/Users/meiri/OneDrive/Documents/trading%20system/schemas/fundamental-sector.schema.json)
- [schemas/fundamental-change.schema.json](/C:/Users/meiri/OneDrive/Documents/trading%20system/schemas/fundamental-change.schema.json)
- [schemas/fundamental-ticker-response.schema.json](/C:/Users/meiri/OneDrive/Documents/trading%20system/schemas/fundamental-ticker-response.schema.json)
- [schemas/fundamentals-dashboard.schema.json](/C:/Users/meiri/OneDrive/Documents/trading%20system/schemas/fundamentals-dashboard.schema.json)
- [openapi/openapi.yaml](/C:/Users/meiri/OneDrive/Documents/trading%20system/openapi/openapi.yaml)
- [sql/postgres-schema.sql](/C:/Users/meiri/OneDrive/Documents/trading%20system/sql/postgres-schema.sql)
